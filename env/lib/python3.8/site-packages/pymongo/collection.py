...
class Collection(common.BaseObject, Generic[_DocumentType]):
    ...
    def bulk_write(
        ...
        :class:`~pymongo.operations.DeleteMany`).
          ...
          >>> result = db.tests.bulk_write(requests)
    ...
    def insert_one(
        ...
        """Insert a single document.
          ...
          >>> db.tests.count_documents({'x': 1})
          0
          >>> result = db.tests.insert_one({'x': 1})
          >>> result.inserted_id
          ObjectId('54f112defba522406c9cc208')
          >>> db.tests.find_one({'x': 1})
    ...
    def insert_many(
        ...
        """Insert an iterable of documents.
          ...
          >>> db.tests.count_documents({})
          0
          >>> result = db.tests.insert_many([{'x': i} for i in range(2)])
          >>> result.inserted_ids
    ...
    def replace_one(
        ...
        """Replace a single document matching the filter.
          ...
          >>> result = db.tests.replace_one({'x': 1}, {'y': 1})
        ...
        document does not exist.
          ...
          >>> result = db.tests.replace_one({'x': 1}, {'x': 1}, True)
          >>> result.matched_count
          0
          >>> result.modified_count
          0
    ...
    def update_one(
        ...
        """Update a single document matching the filter.
          ...
          {'x': 1, '_id': 1}
          {'x': 1, '_id': 2}
          >>> result = db.tests.update_one({'x': 1}, {'$inc': {'x': 3}})
          >>> result.matched_count
          1
          >>> result.modified_count
          1
        ...
        new document based on the filter criteria and update modifications.
          ...
          >>> result = db.tests.update_one({'x': -10}, {'$inc': {'x': 3}}, upsert=True)
          >>> result.matched_count
          0
          >>> result.modified_count
          0
          ...
          >>> db.tests.find_one(result.upserted_id)
    ...
    def update_many(
        ...
        """Update one or more documents that match the filter.
          ...
          {'x': 1, '_id': 1}
          {'x': 1, '_id': 2}
          >>> result = db.tests.update_many({'x': 1}, {'$inc': {'x': 3}})
          >>> result.matched_count
          3
          >>> result.modified_count
          3
    ...
    def delete_one(
        ...
        """Delete a single document matching the filter.
          ...
          >>> db.tests.count_documents({'x': 1})
          3
          >>> result = db.tests.delete_one({'x': 1})
          >>> result.deleted_count
          1
          >>> db.tests.count_documents({'x': 1})
          2
    ...
    def delete_many(
        ...
        """Delete one or more documents matching the filter.
          ...
          >>> db.tests.count_documents({'x': 1})
          3
          >>> result = db.tests.delete_many({'x': 1})
          >>> result.deleted_count
          3
          >>> db.tests.count_documents({'x': 1})
          0
    ...
    def find_raw_batches(self, *args: Any, **kwargs: Any) -> RawBatchCursor[_DocumentType]:
        ...
        :mod:`bson` module.
          ...
          >>> import bson
          >>> cursor = db.tests.find_raw_batches()
          >>> for batch in cursor:
    ...
    def create_indexes(
        ...
        **kwargs: Any,
        ...
        """Create one or more indexes on this collection.
          ...
          >>> db.tests.create_indexes([index1, index2])
    ...
    def list_indexes(
        ...
        """Get a cursor over the index documents for this collection.
          ...
          >>> for index in db.tests.list_indexes():
          ...     print(index)
          ...
    ...
    def index_information(
        ...
        >>> db.tests.create_index("x", unique=True)
        'x_1'
        >>> db.tests.index_information()
        {'_id_': {'key': [('_id', 1)]},
    ...
    def aggregate_raw_batches(
        ...
        **kwargs: Any,
        ...
        :mod:`bson` module.
          ...
          >>> import bson
          >>> cursor = db.tests.aggregate_raw_batches([
    ...
    def find_one_and_delete(
        ...
        **kwargs: Any,
        ...
        """Finds a single document and deletes it, returning the document.
          ...
          >>> db.tests.count_documents({'x': 1})
          2
          >>> db.tests.find_one_and_delete({'x': 1})
        ...
        If multiple documents match *filter*, a *sort* can be applied.
          ...
          >>> for doc in db.tests.find({'x': 1}):
          ...     print(doc)
          ...
          {'x': 1, '_id': 0}
          {'x': 1, '_id': 1}
          {'x': 1, '_id': 2}
          >>> db.tests.find_one_and_delete(
          ...     {'x': 1}, sort=[('_id', pymongo.DESCENDING)])
          {'x': 1, '_id': 2}

        The *projection* option can be used to limit the fields returned.

          >>> db.tests.find_one_and_delete({'x': 1}, projection={'_id': False})
          {'x': 1}
    ...
    def find_one_and_replace(
        ...
        *filter*, rather than modifying the existing document.
          ...
          {'x': 1, '_id': 1}
          {'x': 1, '_id': 2}
          >>> db.tests.find_one_and_replace({'x': 1}, {'y': 1})
          {'x': 1, '_id': 0}
          >>> for doc in db.tests.find({}):
          ...     print(doc)
          ...
    ...
    def find_one_and_update(
        ...
        *upsert*) version of the document instead, use the *return_document*
        ...
        If multiple documents match *filter*, a *sort* can be applied.
          ...
          >>> for doc in db.tests.find({'done': True}):
          ...     print(doc)
          ...
