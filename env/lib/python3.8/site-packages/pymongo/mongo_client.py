...
.. doctest::
  ...
  >>> c["tests-database"]
  Database(MongoClient(host=['localhost:27017'], document_class=dict, tz_aware=False, connect=True), 'tests-database')
"""
...
class MongoClient(common.BaseObject, Generic[_DocumentType]):
    ...
    def get_database(
        ...
        this :class:`MongoClient`.
          ...
          ...     'tests', read_preference=ReadPreference.SECONDARY)
          >>> db2.read_preference
