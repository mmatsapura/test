"""pytest-bdd missing tests code generation."""
...
def add_options(parser: Parser) -> None:
    ...
    group._addoption(
        ...
        default=False,
        help="Generate missing bdd tests code for given feature files and exit.",
    )
...
def generate_code(features: list[Feature], scenarios: list[ScenarioTemplate], steps: list[Step]) -> str:
    """Generate tests code for the given filenames."""
    grouped_steps = group_steps(steps)
    template = template_lookup.get_template("tests.py.mak")
...
def print_missing_code(scenarios: list[ScenarioTemplate], steps: list[Step]) -> None:
    ...
    for scenario in scenarios:
        tw.line()
        tw.line(
            'Scenario "{scenario.name}" is not bound to any tests in the feature "{scenario.feature.name}"'
    ...
    tw.line("Please place the code above to the tests file(s):")
    tw.line()
